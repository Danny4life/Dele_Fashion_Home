...
import com.example.dele_fashion_home.model.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleUserAlreadyExistsException(final UsersAlreadyExistsException ex){
